...
var GaugeDemoComponent = (function () {
    function GaugeDemoComponent() {
        ...
        this.inputLevels = { curr: this.gaugeSettings.outerScaleRange.s, targ: this.calcTarget() };
        this.delay = Math.round(Math.random() * 20);
        this.timeoutLen = 500;
        this.tick = 0;
    ...
    GaugeDemoComponent.prototype.ngAfterViewInit = function () {
        ...
        this.gauge = new gauge_1.Gauge(this.gaugeCanvas, this.gaugeSettings);
    ...
    GaugeDemoComponent.prototype.resetSettings = function () {
    ...
    GaugeDemoComponent.prototype.setSliderValues = function () {
    ...
    GaugeDemoComponent.prototype.drawSlider = function () {
    ...
    GaugeDemoComponent.prototype.drawLine = function (i, y) {
    ...
    GaugeDemoComponent.prototype.setMouseDown = function (isDown) {
    ...
    GaugeDemoComponent.prototype.isOnSlider = function (mousePos) {
    ...
    GaugeDemoComponent.prototype.calcTarget = function () {
    ...
    GaugeDemoComponent.prototype.toggleDemo = function () {
        var _this = this;
        if (!this.isRunning) {
            this.isRunning = true;
    ...
    GaugeDemoComponent.prototype.runDemo = function () {
    ...
    GaugeDemoComponent.prototype.resetSliderCtrl = function () {
        this.sliderCtrlValue = 0;
    }; // end resetSliderCtrl()
    GaugeDemoComponent.prototype.onSliderInput = function () {
        console.log('input');
        if (!this.isRunning) {
    ...
    ], GaugeDemoComponent.prototype, "gaugeCanvas", void 0);
    __decorate([
        core_1.ViewChild("sliderCanvas"), 
        __metadata('design:type', Object)
    ], GaugeDemoComponent.prototype, "sliderCanvas", void 0);
